...
default_username=${GIT_DEPLOY_USERNAME:-Rocket Bound}
default_email=${GIT_DEPLOY_EMAIL:-rocketbound.contact@gmail.com}

#repository to deploy to. must be readable and writable.
repo=${GIT_DEPLOY_REPO:-git@github.com-rocketbound:RocketBound/blog.git}
